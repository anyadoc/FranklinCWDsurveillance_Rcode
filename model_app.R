...
##
mabl1dp_final$samplesize <- "10% adult harvest"
mabl1dp_final$TotalCWD <- "0.2% CWD prevalence"

###
data_ma_bl2 <- read.csv("CWDsurveillanceMO_bl2.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl2dp_final$samplesize <- "20% adult harvest"
mabl2dp_final$TotalCWD <- "0.2% CWD prevalence"

###
data_ma_bl3 <- read.csv("CWDsurveillanceMO_bl3.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl3dp_final$samplesize <- "30% adult harvest"
mabl3dp_final$TotalCWD <- "0.2% CWD prevalence"

###
data_ma_bl4 <- read.csv("CWDsurveillanceMO_bl4.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl4dp_final$samplesize <- "40% adult harvest"
mabl4dp_final$TotalCWD <- "0.2% CWD prevalence"

###
data_ma_bl5 <- read.csv("CWDsurveillanceMO_bl5.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl5dp_final$samplesize <- "50% adult harvest"
mabl5dp_final$TotalCWD <- "0.2% CWD prevalence"

###
data_ma_bl6 <- read.csv("CWDsurveillanceMO_bl6.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl6dp_final$samplesize <- "10% adult harvest"
mabl6dp_final$TotalCWD <- "0.4% CWD prevalence"

###
data_ma_bl7 <- read.csv("CWDsurveillanceMO_bl7.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl7dp_final$samplesize <- "20% adult harvest"
mabl7dp_final$TotalCWD <- "0.4% CWD prevalence"

###
data_ma_bl8 <- read.csv("CWDsurveillanceMO_bl8.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl8dp_final$samplesize <- "30% adult harvest"
mabl8dp_final$TotalCWD <- "0.4% CWD prevalence"

###
data_ma_bl9 <- read.csv("CWDsurveillanceMO_bl9.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl9dp_final$samplesize <- "40% adult harvest"
mabl9dp_final$TotalCWD <- "0.4% CWD prevalence"

###
data_ma_bl10 <- read.csv("CWDsurveillanceMO_bl10.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl10dp_final$samplesize <- "50% adult harvest"
mabl10dp_final$TotalCWD <- "0.4% CWD prevalence"

###
data_ma_bl11 <- read.csv("CWDsurveillanceMO_bl11.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl11dp_final$samplesize <- "10% adult harvest"
mabl11dp_final$TotalCWD <- "0.6% CWD prevalence"

###
data_ma_bl12 <- read.csv("CWDsurveillanceMO_bl12.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl12dp_final$samplesize <- "20% adult harvest"
mabl12dp_final$TotalCWD <- "0.6% CWD prevalence"

###
data_ma_bl13 <- read.csv("CWDsurveillanceMO_bl13.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl13dp_final$samplesize <- "30% adult harvest"
mabl13dp_final$TotalCWD <- "0.6% CWD prevalence"

###
data_ma_bl14 <- read.csv("CWDsurveillanceMO_bl14.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl14dp_final$samplesize <- "40% adult harvest"
mabl14dp_final$TotalCWD <- "0.6% CWD prevalence"

###
data_ma_bl15 <- read.csv("CWDsurveillanceMO_bl15.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl15dp_final$samplesize <- "50% adult harvest"
mabl15dp_final$TotalCWD <- "0.6% CWD prevalence"

###
data_ma_bl16 <- read.csv("CWDsurveillanceMO_bl16.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl16dp_final$samplesize <- "10% adult harvest"
mabl16dp_final$TotalCWD <- "0.8% CWD prevalence"

###
data_ma_bl17 <- read.csv("CWDsurveillanceMO_bl17.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl17dp_final$samplesize <- "20% adult harvest"
mabl17dp_final$TotalCWD <- "0.8% CWD prevalence"

###
data_ma_bl18 <- read.csv("CWDsurveillanceMO_bl18.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl18dp_final$samplesize <- "30% adult harvest"
mabl18dp_final$TotalCWD <- "0.8% CWD prevalence"

###
data_ma_bl19 <- read.csv("CWDsurveillanceMO_bl19.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl19dp_final$samplesize <- "40% adult harvest"
mabl19dp_final$TotalCWD <- "0.8% CWD prevalence"

###
data_ma_bl20 <- read.csv("CWDsurveillanceMO_bl20.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl20dp_final$samplesize <- "50% adult harvest"
mabl20dp_final$TotalCWD <- "0.8% CWD prevalence"

###
data_ma_bl21 <- read.csv("CWDsurveillanceMO_bl21.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl21dp_final$samplesize <- "10% adult harvest"
mabl21dp_final$TotalCWD <- "1% CWD prevalence"

###
data_ma_bl22 <- read.csv("CWDsurveillanceMO_bl22.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl22dp_final$samplesize <- "20% adult harvest"
mabl22dp_final$TotalCWD <- "1% CWD prevalence"

###
data_ma_bl23 <- read.csv("CWDsurveillanceMO_bl23.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl23dp_final$samplesize <- "30% adult harvest"
mabl23dp_final$TotalCWD <- "1% CWD prevalence"

###
data_ma_bl24 <- read.csv("CWDsurveillanceMO_bl24.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl24dp_final$samplesize <- "40% adult harvest"
mabl24dp_final$TotalCWD <- "1% CWD prevalence"

###
data_ma_bl25 <- read.csv("CWDsurveillanceMO_bl25.csv", header = TRUE)  #model application scenario baseline 2
...
##
mabl25dp_final$samplesize <- "50% adult harvest"
mabl25dp_final$TotalCWD <- "1% CWD prevalence"

###
data_ma_alt1 <- read.csv("CWDsurveillanceMO_alt1.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt1dp_final$samplesize <- "10% adult harvest"
maalt1dp_final$TotalCWD <- "0.2% CWD prevalence"
##

data_ma_alt2 <- read.csv("CWDsurveillanceMO_alt2.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt2dp_final$samplesize <- "20% adult harvest"
maalt2dp_final$TotalCWD <- "0.2% CWD prevalence"
##

data_ma_alt3 <- read.csv("CWDsurveillanceMO_alt3.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt3dp_final$samplesize <- "30% adult harvest"
maalt3dp_final$TotalCWD <- "0.2% CWD prevalence"
##

data_ma_alt4 <- read.csv("CWDsurveillanceMO_alt4.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt4dp_final$samplesize <- "40% adult harvest"
maalt4dp_final$TotalCWD <- "0.2% CWD prevalence"
##

data_ma_alt5 <- read.csv("CWDsurveillanceMO_alt5.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt5dp_final$samplesize <- "50% adult harvest"
maalt5dp_final$TotalCWD <- "0.2% CWD prevalence"
##

data_ma_alt6 <- read.csv("CWDsurveillanceMO_alt6.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt6dp_final$samplesize <- "10% adult harvest"
maalt6dp_final$TotalCWD <- "0.4% CWD prevalence"
##

data_ma_alt7 <- read.csv("CWDsurveillanceMO_alt7.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt7dp_final$samplesize <- "20% adult harvest"
maalt7dp_final$TotalCWD <- "0.4% CWD prevalence"
##

data_ma_alt8 <- read.csv("CWDsurveillanceMO_alt8.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt8dp_final$samplesize <- "30% adult harvest"
maalt8dp_final$TotalCWD <- "0.4% CWD prevalence"
##

data_ma_alt9 <- read.csv("CWDsurveillanceMO_alt9.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt9dp_final$samplesize <- "40% adult harvest"
maalt9dp_final$TotalCWD <- "0.4% CWD prevalence"
##

data_ma_alt10 <- read.csv("CWDsurveillanceMO_alt10.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt10dp_final$samplesize <- "50% adult harvest"
maalt10dp_final$TotalCWD <- "0.4% CWD prevalence"
##

data_ma_alt11 <- read.csv("CWDsurveillanceMO_alt11.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt11dp_final$samplesize <- "10% adult harvest"
maalt11dp_final$TotalCWD <- "0.6% CWD prevalence"
##

data_ma_alt12 <- read.csv("CWDsurveillanceMO_alt12.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt12dp_final$samplesize <- "20% adult harvest"
maalt12dp_final$TotalCWD <- "0.6% CWD prevalence"
##

data_ma_alt13 <- read.csv("CWDsurveillanceMO_alt13.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt13dp_final$samplesize <- "30% adult harvest"
maalt13dp_final$TotalCWD <- "0.6% CWD prevalence"
##

data_ma_alt14 <- read.csv("CWDsurveillanceMO_alt14.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt14dp_final$samplesize <- "40% adult harvest"
maalt14dp_final$TotalCWD <- "0.6% CWD prevalence"
##

data_ma_alt15 <- read.csv("CWDsurveillanceMO_alt15.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt15dp_final$samplesize <- "50% adult harvest"
maalt15dp_final$TotalCWD <- "0.6% CWD prevalence"
##

data_ma_alt16 <- read.csv("CWDsurveillanceMO_alt16.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt16dp_final$samplesize <- "10% adult harvest"
maalt16dp_final$TotalCWD <- "0.8% CWD prevalence"
##

data_ma_alt17 <- read.csv("CWDsurveillanceMO_alt17.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt17dp_final$samplesize <- "20% adult harvest"
maalt17dp_final$TotalCWD <- "0.8% CWD prevalence"
##

data_ma_alt18 <- read.csv("CWDsurveillanceMO_alt18.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt18dp_final$samplesize <- "30% adult harvest"
maalt18dp_final$TotalCWD <- "0.8% CWD prevalence"
##

data_ma_alt19 <- read.csv("CWDsurveillanceMO_alt19.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt19dp_final$samplesize <- "40% adult harvest"
maalt19dp_final$TotalCWD <- "0.8% CWD prevalence"
##

data_ma_alt20 <- read.csv("CWDsurveillanceMO_alt20.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt20dp_final$samplesize <- "50% adult harvest"
maalt20dp_final$TotalCWD <- "0.8% CWD prevalence"
##

data_ma_alt21 <- read.csv("CWDsurveillanceMO_alt21.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt21dp_final$samplesize <- "10% adult harvest"
maalt21dp_final$TotalCWD <- "1% CWD prevalence"
##

data_ma_alt22 <- read.csv("CWDsurveillanceMO_alt22.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt22dp_final$samplesize <- "20% adult harvest"
maalt22dp_final$TotalCWD <- "1% CWD prevalence"
##

data_ma_alt23 <- read.csv("CWDsurveillanceMO_alt23.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt23dp_final$samplesize <- "30% adult harvest"
maalt23dp_final$TotalCWD <- "1% CWD prevalence"
##

data_ma_alt24 <- read.csv("CWDsurveillanceMO_alt24.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt24dp_final$samplesize <- "40% adult harvest"
maalt24dp_final$TotalCWD <- "1% CWD prevalence"
##

data_ma_alt25 <- read.csv("CWDsurveillanceMO_alt25.csv", header = TRUE)  #model application scenario baseline 2
...
##
maalt25dp_final$samplesize <- "50% adult harvest"
